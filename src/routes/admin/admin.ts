...
const API_PREFIX = process.env.API_PREFIX || "yo";
AdminJS.registerAdapter(AdminJSSequelize)

const User = sequelize.model('User')
const UserRole = sequelize.model('UserRole')
const Organization = sequelize.model('Organization')
const AuthorizationLink = sequelize.model('AuthorizationLink')
const RefreshToken = sequelize.model('RefreshToken')
const DataType = sequelize.model('DataType')
const Property = sequelize.model('Property')
const FilledProperty = sequelize.model('FilledProperty')
...
const Components = {
  CSVImport: componentLoader.add('CSVImport', '../../admin/components/import-action-component'),
}
